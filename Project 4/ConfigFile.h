...
class ConfigFile 
{
    int Processor, Monitor,HardDrive,scheduling, Printer,Keyboard,Memory, Mouse,Speaker, Logged,Projector,Scanner,sysMemory,printerQty, hardDriveQty, memoryBlock, projectorQty, processorQuantum;
