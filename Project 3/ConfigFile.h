...
class ConfigFile 
{
    int Processor, Monitor,HardDrive, Printer,Keyboard,Memory, Mouse,Speaker, Logged,Projector,Scanner,sysMemory,printerQty, hardDriveQty, memoryBlock, projectorQty;
